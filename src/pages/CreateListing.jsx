...
async function handleSubmit(event) {
  ...
  if (uploadedImageUrls.length > 0) {
    ...
    if (imagesError) {
      console.error('Erreur enregistrement photos :', imagesError)
    }
  }
